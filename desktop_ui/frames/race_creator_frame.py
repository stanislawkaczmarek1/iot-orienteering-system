...
#     def __init__(self, race_service: RaceService, checkpoint_service: CheckpointService, parent=None):
...
#             dt = QDateTime(QDate(race.date.year, race.date.month, race.date.day), QTime(race.date.hour, race.date.minute, race.date.second))
